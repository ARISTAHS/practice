...
export const portFolioDate = [
  ...
  },
  {
    ...
    details:`- 다양한 모바일 기기의 해상도에 맞춰 제작
             - 마우스가 아닌 사용자의 터치를 중점적으로 제작
             - PC와 다른 모바일에 맞는 기능과 컨텐츠 재정렬` ,
    img : mobile,
  ...
  },
  {
    ...
    details:`- 다양한 해상도의 디바이스에서 이용 가능하게 제작
             - PC, 태블릿, 모바일 각각에 최적화된 UI
             - 실시간으로 반응하여 변화하는 레이아웃` ,
    img : media,
  ...
  },
  {
    ...
    details:`- 부트스트랩 프레임워크를 사용
             - 콤포넌트와 부트스트랩 CSS를 활용한 레이아웃
             - 다양한 기기에 따라 변화하는 그리드 시스템 사용` ,
    img : bootstrap,
  ...
  },
  {
    ...
    details:`- 웹사이트 제작 도구인 워드프레스 사용
             - 워드프레스의 다양한 테마와 플러그인 활용
             - 실시간으로 반응하여 변화하는 레이아웃` ,
    img : wordpress,
